...
from retail_chain.models import Contacts, Product, Link
...
class LinkTestCase(APITestCase):
    ...
    def test_create_link(self):
        ...
        response = self.client.post(reverse('retail-chain:api-chain-create'), data=data)  # Отправка запроса
    ...
    def test_list_links(self):
        """Тестирование ендпоинта просмотра списка звеньев сети"""

        response = self.client.get(reverse('retail-chain:api-chain-list'))  # Запрос на получение списка уроков
    ...
    def test_update_link(self):
        ...
        response = self.client.put(reverse('retail-chain:api-chain-update', args=[self.plant.pk]), data=data)
    ...
    def test_destroy_link(self):
        """Тестирование эндпоинта удаления звена сети"""

        response = self.client.delete(reverse('retail-chain:api-chain-destroy', args=[self.plant.pk]))
